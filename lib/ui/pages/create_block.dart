...
class CreateBlockPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Size _sizeSmall = textSize('00000000',
        Theme.of(context).textTheme.headline5.copyWith(fontSize: 18.0, height: 1.05, fontWeight: FontWeight.w900));
            ...
            child: Container(
              ...
              child: DefaultTextStyle(
                style: Theme.of(context).textTheme.headline5.copyWith(
                    ...
                    height: 1.05,
                    fontSize: _value < 0.4 ? 24.0 : map(_value, 0.4, 1.0, 24.0, 18.0)),
                child: Text(e),
              ),
            ),
          );
